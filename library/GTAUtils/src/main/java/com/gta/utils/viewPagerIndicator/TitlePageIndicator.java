 ...
 */
package com.gta.utils.viewPagerIndicator;
...
/**
 * A TitlePageIndicator is a PageIndicator which displays the title of left com.cardapp.mainland.publibs.imagemodule.view
 * (if exist), the title of the current select com.cardapp.mainland.publibs.imagemodule.view (centered) and the title of
 * the right com.cardapp.mainland.publibs.imagemodule.view (if exist). When the user scrolls the ViewPager then titles are
 * also scrolled.
 */
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    /** Left and right side padding for not active com.cardapp.mainland.publibs.imagemodule.view titles. */
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        //Retrieve the colors to be used for this com.cardapp.mainland.publibs.imagemodule.view and apply them.
     ...
     * (non-Javadoc)
     *
     * @see android.com.cardapp.mainland.publibs.imagemodule.view.View#onDraw(android.graphics.Canvas)
     */
    @Override
    protected void onDraw(Canvas canvas) {
        ...
        //Verify if the current com.cardapp.mainland.publibs.imagemodule.view must be clipped to the screen
        ...
        if (mCurrentPage > 0) {
            for (int i = mCurrentPage - 1; i >= 0; i--) {
                ...
                if (bound.left < leftClip) {
                    ...
                    //Except if there's an intersection with the right com.cardapp.mainland.publibs.imagemodule.view
        ...
        if (mCurrentPage < countMinusOne) {
            for (int i = mCurrentPage + 1 ; i < count; i++) {
                ...
                if (bound.right > rightClip) {
                    ...
                    //Except if there's an intersection with the left com.cardapp.mainland.publibs.imagemodule.view
     ...
     *            current bounds.
     * @param curViewWidth
     *            width of the com.cardapp.mainland.publibs.imagemodule.view.
     */
    ...
    /**
     * Calculate the bounds for a com.cardapp.mainland.publibs.imagemodule.view's title
     *
     * @param index
     * @param paint
     * @return
