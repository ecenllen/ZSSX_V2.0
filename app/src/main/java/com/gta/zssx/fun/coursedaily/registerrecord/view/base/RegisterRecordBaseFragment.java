 ...
 */
public abstract class RegisterRecordBaseFragment <V extends BaseView,P extends BasePresenter<V>> extends BaseMvpFragment<V,P> {

    public static final String PAGE_TAG = RegisterRecordBaseFragment.class.getSimpleName();

    protected AlreadyRegisteredRecordActivity mActivity;
    ...
    public void onAttach(Activity activity) {
        ...
        if (activity instanceof AlreadyRegisteredRecordActivity) {
            mActivity = (AlreadyRegisteredRecordActivity) activity;
