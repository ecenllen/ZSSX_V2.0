package com.gta.zssx.fun.personalcenter.view.base;
...
import com.gta.utils.module.OnModuleFragmentListener;
 ...
 * @since 1.0.0
 */
public class PersonalCenter implements BaseModule {

    private  Context mContext;
    private  String mServerAddress;
    private static String sPERSONALCENTER = "PERSONALCENTER";
    ...
    public static PersonalCenter getInstance() {
        return singleton.personalCenter;
    }

    private static class singleton {
        static final PersonalCenter personalCenter = new PersonalCenter();
    }
    ...
    public void displayActivity() {
        PersonCenterActivity.start(mContext);
    }
    ...
    public  void saveObject(Object object, String falg) {
        SharedPreferences preferences = mContext.getSharedPreferences(sPERSONALCENTER,
