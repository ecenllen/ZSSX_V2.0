...
public class ClassroomIsRegisterPresenter extends BasePresenter<ClassroomIsRegisterView> {
    private UserBean mUserBean;

    public ClassroomIsRegisterPresenter () {
        super ();
        try {
     ...
     * 获取数据接口
     *
     * @param type  区分已登记跟未登记
     * @param state 区分是否下拉刷新
     */
