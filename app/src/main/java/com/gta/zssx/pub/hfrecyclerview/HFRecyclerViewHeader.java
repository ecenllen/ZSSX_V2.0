package com.gta.zssx.pub.hfrecyclerview;
    ...
    public void setState (int state) {
        ...
        switch (state) {
            case STATE_NORMAL:
                ...
                headHintTv.setText(R.string.lfrecyclerview_header_hint_normal);
            ...
            case STATE_READY:
                if (mState != STATE_READY) {
                    ...
                    headHintTv.setText(R.string.lfrecyclerview_header_hint_ready);
                }
                break;
            case STATE_REFRESH:
                mProgressBar.startLoad();
                headHintTv.setText(R.string.lfrecyclerview_header_hint_loading);
                break;
            case STATE_SUCCESS:
                mProgressBar.stopLoad();
                headHintTv.setText(R.string.lfrecyclerview_header_hint_success);
                arrowIv.setImageResource(R.drawable.lfrecyclerview_success);
            ...
            case STATE_REFRESH_FAIL:
                mProgressBar.stopLoad();
                headHintTv.setText(R.string.lfrecyclerview_header_hint_failt);
                arrowIv.setImageResource(R.drawable.lfrecyclerview_error);
