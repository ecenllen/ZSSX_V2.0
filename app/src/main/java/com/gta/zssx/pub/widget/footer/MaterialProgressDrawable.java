...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    /**
     * Set the start4Result and end trim for the progress spinner arc.
     *
     * @param startAngle start4Result angle
    ...
    private static class Ring {
        ...
        // base_loading_progress circle should currently display. As the base_loading_progress circle is
        ...
        /**
         * If the start4Result / end trim are offset to begin with, store them so that
        ...
        /**
         * Reset the progress spinner to default rotation, start4Result and end angles.
         */
