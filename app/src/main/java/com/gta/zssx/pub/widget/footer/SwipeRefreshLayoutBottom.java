package com.gta.zssx.pub.widget.footer;
...
public class SwipeRefreshLayoutBottom extends ViewGroup {
	...
	private static final String LOG_TAG = SwipeRefreshLayoutBottom.class
			.getSimpleName();
	...
	// Target is returning to its start4Result offset because it was cancelled or a
	...
	private AnimationListener mRefreshListener = new AnimationListener() {
		...
		public void onAnimationEnd(Animation animation) {
			if (mRefreshing) {
				...
				// Return the circle to its start4Result position
				if (mScale) {
	 ...
	 */
	/*
	 * public void setProgressViewOffset(boolean scale, int start4Result, int end) {
	 * mScale = scale; mCircleView.setVisibility(View.GONE); mOriginalOffsetTop
	 * = mCurrentTargetOffsetTop = start4Result; mSpinnerFinalOffset = end;
	...
	public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (!mUsingCustomStart && !mOriginalOffsetCalculated) {
			...
			mCurrentTargetOffsetTop = mOriginalOffsetTop = getMeasuredHeight()
					- mCircleView.getMeasuredHeight(); // TODO
		}
		mCircleViewIndex = -1;
	 ...
	 */
	/*
	 * public boolean canChildScrollUp() { if (android.os.Build.VERSION.SDK_INT
	 * < 14) { if (mTarget instanceof AbsListView) { final AbsListView
	 * absListView = (AbsListView) mTarget; return absListView.getChildCount() >
	 * 0 && (absListView.getFirstVisiblePosition() > 0 ||
	 * absListView.getChildAt(0) .getTop() < absListView.getPaddingTop()); }
	 * else { return mTarget.getScrollY() > 0; } } else { return
	...
	public boolean canChildScrollUp() {
		...
		if (android.os.Build.VERSION.SDK_INT < 14) {
			if (mTarget instanceof AbsListView) {
				...
				Log.e("ANDREY", " absListView.getFirstVisiblePosition() "
						+ absListView.getFirstVisiblePosition());
				Log.e("ANDREY", " absListView.getLastVisiblePosition() "
						+ absListView.getLastVisiblePosition());
				Log.e("ANDREY",
						" absListView.getCount() " + absListView.getCount());
