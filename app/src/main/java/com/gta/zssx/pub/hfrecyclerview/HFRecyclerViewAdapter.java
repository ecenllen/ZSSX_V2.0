...
public class HFRecyclerViewAdapter extends RecyclerView.Adapter {
        ...
        if (itemClickListener != null) {
            holder.itemView.setOnClickListener (new View.OnClickListener () {
                ...
                public void onClick (View v) {
                    itemClickListener.onItemClick (v, holder.getLayoutPosition ()-getHeadViewCount ());
                }
            });
            ...
            holder.itemView.setOnLongClickListener (new View.OnLongClickListener () {
                ...
                public boolean onLongClick (View v) {
                    itemClickListener.onLongItemClick (v, holder.getLayoutPosition ()-getHeadViewCount ());
                    return true;
                }
            });
        }
    ...
    public int getItemViewType (int position) {
        ...
        return mAdapter.getItemViewType (position - getHeadViewCount ());
    }
